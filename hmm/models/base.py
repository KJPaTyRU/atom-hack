...
from hmm.core.utils.common import FilterType, camel_to_snake
...
class Base:
    ...
    @classmethod
    @cache
    def all_fields(cls) -> dict[str, Column]:
...
class BoundDbModel:
    ...
    @classmethod
    def date_bounds(cls, **eq_filters: FilterType | list[bool]) -> "Select":
